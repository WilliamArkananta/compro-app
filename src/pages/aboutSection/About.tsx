...
function About() {
  return (
    <section className="flex flex-col justify-center items-center gap-8 lg:w-[1164px]">
      ...
      <div className="body">
        <p className="text-body">
          ...
          mobile applications. My work spans the end-to-end design process, from
          conducting user research and competitor analysis to developing
